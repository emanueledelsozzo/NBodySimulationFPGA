...
void nbody(ap_uint<512> *p_x, ap_uint<512> *p_y, ap_uint<512> *p_z, ap_uint<512> *a_x, ap_uint<512> *a_y, ap_uint<512> *a_z, ap_uint<512> *c, my_type *EPS_ptr, unsigned int *tiling_factor_ptr){

#pragma HLS INTERFACE m_axi port=p_x offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=p_y offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=p_z offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=a_x offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=a_y offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=a_z offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=c   offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=EPS_ptr offset=slave bundle=gmem1
#pragma HLS INTERFACE m_axi port=tiling_factor_ptr offset=slave bundle=gmem2
...
#pragma HLS STREAM variable=out_z depth=1 dim=1
		...
		memcpy(a_x + outer_tile, (const ap_uint<512>*) (local_a_x),
				(TILE_SIZE) * sizeof(ap_uint<512> ));
		memcpy(a_y + outer_tile, (const ap_uint<512>*) (local_a_y),
				(TILE_SIZE) * sizeof(ap_uint<512> ));
		memcpy(a_z + outer_tile, (const ap_uint<512>*) (local_a_z),
				(TILE_SIZE) * sizeof(ap_uint<512> ));
	}
